...
async def transcribe(
    ...
    # The merged audio_file contains BOTH mic + system audio mixed down.
    # Always prefer it for transcription — it has the complete conversation.
    # Only fall back to individual tracks if the merged file is missing/empty.
    primary = audio_file
