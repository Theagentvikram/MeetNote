...
async def transcribe_audio(
    ...
    try:
        logger.info(f"Received transcription request: {title}")
        ...
        try:
            ...
            meeting_data = {
                "title": title or "Meeting Recording",
                "transcript": transcript_result["transcript"],
                "summary": transcript_result["summary"],
                "key_points": ["Review full transcript for AI generated points"],
                "action_items": ["Review full transcript for AI generated actions"],
