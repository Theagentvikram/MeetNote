...
final class AppSettings: ObservableObject {
    ...
    /// Display name for the "other" speaker in dual-track transcripts (default: "Other")
    @Published var otherSpeakerName: String {
        didSet { UserDefaults.standard.set(otherSpeakerName, forKey: "otherSpeakerName") }
    }
    ...
    private init() {
        ...
        self.otherSpeakerName = defaults.string(forKey: "otherSpeakerName") ?? "Other"
    }
    ...
    var recordingsDirectory: URL {
        ...
        let dir = downloads.appendingPathComponent("meetnote", isDirectory: true)
